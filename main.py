...
class HelperFrame(wx.Frame):
    def __init__(self):
        ...
        self.text_ctrl = wx.TextCtrl(panel, size=(275, -1))
        self.text_ctrl.SetPosition((10, 30))
        ...
        directory_information.SetPosition((10, 155))
        self.directory_output = wx.DirPickerCtrl(panel, size=(360, -1))
        self.directory_output.SetPosition((10, 180))
        self.format_selection = wx.Choice(panel, choices=available_formats, pos=(10, 60))
        self.format_selection.SetSelection(1)
        self.quality_selection = wx.Choice(panel, choices=quality_formats, pos=(140, 60))
        self.quality_selection.SetSelection(5)
        self.subtitle_box = wx.CheckBox(panel, label="Subtitles?", pos=(210, 63))
        download_button = wx.Button(panel, label='Download')
        download_button.Bind(wx.EVT_BUTTON, self.on_press)
        download_button.SetPosition((295, 30))
        self.Show()
